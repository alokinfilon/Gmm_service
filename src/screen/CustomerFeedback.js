...
export default class CustomerFeedback extends Component {
                        ...
                        if (res.status == 200) {
                          ...
                          res.json().then(res => {
                            ...
                            if (res.status == "success") {
                              ...
                              this.setState({ loading: false, loading1: false, Feedback: this.state.Feedback.concat(res.data), radioItems: res.sort_by, page: parseInt(this.state.page) + parseInt(pagelimit) })
  ...
  changeActiveRadioButton(index) {
    ...
    AssignedArray = [];
    this.setState({ order_field: this.state.radioItems[index].value, modalVisible: false, page: 0, Feedback: [] }, () => {
      setTimeout(() => {
        this.Feedback();
      }, 500)
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          if (this.state.sort_direction == 'asc') {
            AssignedArray = [];
            this.setState({
              sort_direction: 'desc', page: 0, Feedback: [],
            }, () => {
              this.Feedback()
            });
          } else {
            AssignedArray = [];
            this.setState({
              sort_direction: 'asc', page: 0, Feedback: [],
            }, () => {
              this.Feedback()
            });
          }
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: Colors.primary }}>
        ...
        <Header
            ...
            // press={() =>
            //   this.props.navigation.navigate('AddFeedback', {screen: 'view'})
            // }
          />
           ...
           {this.state.page == 0 && this.state.Feedback.length < 1 && this.state.loading == false ? 
...
<Text
                        ...
                        Call Date {moment(item.call_date).format("DD/MM/YYYY")}
                      </Text>
                      ...
                      <Text style={styles.value}>{item.call_no}</Text>
                       ...
                       <View style={styles.rowItem}>
                         ...
                         <View style={{flex: 1, flexDirection: 'column'}}>
                      <Text style={styles.value}>{item.caller_name}</Text>
                         </View>
                       </View>
                        ...
                        <View style={styles.rowItem}>
                         ...
                         <View style={{flex: 1, flexDirection: 'column'}}>
                      <Text style={styles.value}>{item.user} {item.user_type == 3 ? "- Engineer" : "- Manager"}</Text>
                         </View>
                       </View>


                       <View style={styles.rowItem}>
                         <Text style={styles.label}>Rating Date</Text>
                         <View style={{flex: 1, flexDirection: 'column'}}>
                         <Text style={styles.value}>{moment(item.rating_date).format("DD/MM/YYYY hh:mm a")}</Text>                         
                         </View>
                       </View>
                       ...
                       <View style={styles.rowItem}>
                         ...
                         <View style={{flex: 1, flexDirection: 'column'}}>
                           <Text style={styles.value}>{item.rating_star} Stars</Text>
                         </View>
                       </View>
                       ...
                       <View style={styles.rowItem}>
                         ...
                         <View style={{flex: 1, flexDirection: 'column'}}>
                           <Text style={styles.value}>{item.rating_feedback}</Text>
                         </View>
                       </View>
...
{/* 
                    <TouchableOpacity
                      onPress={() => {
                        this.props.navigation.navigate('AddFeedback',{ screen: 'edit',item:item})
                      }}
...
//   changeActiveRadioButton(index) {
//     this.setState({order_field: this.state.radioItems[index].value}, () => {
...
//                         <View style={{flex: 1, flexDirection: 'column'}}>
//                           <Text style={styles.value}>007</Text>
//                         </View>
//                       </View>
...
//                         <View style={{flex: 1, flexDirection: 'column'}}>
//                           <Text style={styles.value}>BEXIMCO PHARMACEUTICALS LTD</Text>
//                         </View>
//                       </View>
...
//                         <Text style={styles.label}>Company</Text>
//                         <View style={{flex: 1, flexDirection: 'column'}}>
//                           <Text style={styles.value}>	INDIAN ADDITIVIES LTD</Text>
//                         </View>
//                       </View>
...
//                         <Text style={styles.label}>Contact Person</Text>
//                         <View style={{flex: 1, flexDirection: 'column'}}>
//                           <Text style={styles.value}>Mr. Ramkrishna Patel</Text>
//                         </View>
//                       </View>
...
//                         <Text style={styles.label}>Call No</Text>
//                         <View style={{flex: 1, flexDirection: 'column'}}>
//                           <Text style={styles.value}>CHR1234</Text>
//                         </View>
//                       </View>
...
//                         <Text style={styles.label}>Rating Date</Text>
//                         <View style={{flex: 1, flexDirection: 'column'}}>
//                           <Text style={styles.value}>24/05/2019</Text>
//                         </View>
//                       </View>
...
//                         <Text style={styles.label}>Rating</Text>
//                         <View style={{flex: 1, flexDirection: 'column'}}>
//                           <Text style={styles.value}>2 Stars</Text>
//                         </View>
//                       </View>
...
//                         <Text style={styles.label}>Review</Text>
//                         <View style={{flex: 1, flexDirection: 'column'}}>
//                           <Text style={styles.value}>Good Service</Text>
//                         </View>
//                       </View>
